 ...
 * @author tss
 */
public class Persona implements Comparable<Persona> { // alt invio, propone alternative e suggerimenti
    ...
    @Override
    public int compareTo(Persona o) { // per esempio, ordino le persone per cognome
